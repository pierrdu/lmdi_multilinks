...
$lang = array_merge($lang, array(
	...
	'ACP_MULTILINK_ICO'		=> 'Icône classique à attribuer',
	...
	'ACP_ML_ICO_EXPLAIN'	=> 'Indiquez ici l’icône classique à utiliser. Par défaut, l’extension utilise icon-faq. Voir également icon-acp, icon-mcp, icon-search, etc.',
	));
